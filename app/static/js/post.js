...
function addcar() {
	...
	var car_category_name = $('#car_category_name').val();
	...
	var data = JSON.stringify({"car_plate_number": car_plate_number, "car_owner_id": car_owner_id, "car_brandname": car_brandname,
